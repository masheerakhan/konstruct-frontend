...
const colorMap = {
    orange: "border-orange-200 hover:border-orange-400 text-orange-500 bg-orange-50",
    ...
    yellow: "border-yellow-200 hover:border-yellow-400 text-yellow-500 bg-yellow-50",
    ...
    indigo: "border-indigo-200 hover:border-indigo-400 text-indigo-500 bg-indigo-50",
    emerald:
