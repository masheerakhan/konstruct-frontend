...
export default function MakerDashboard() {
  ...
  //   try {
  //     await submitSafetyChecklist(detail.id, {
  //       ...pendingSubmitPayload,
  //       maker_signature_base64: signatureBase64,
  //     });
  //     showToast("Submitted successfully", "success");
  //     setIsMakerSignatureModalOpen(false);
  //     setPendingSubmitPayload(null);
...
const handleSubmitWithMakerSignature = async () => {
  ...
  const signatureFile = new File([bytes], `maker-signature-${detail.id}.png`, {
    type: "image/png",
  });
                ...
                <div className="mb-6 grid grid-cols-3 gap-3 sm:gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      count: makerCompletedChecklists.length,
                    },
