            ...
            <div className="flex flex-wrap items-center gap-3 rounded-lg bg-white border border-orange-100 px-4 py-3 shadow-sm">
                ...
                <div className="ml-auto flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={`inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium ${selectedRows.size === 0
                ...
                <table className="w-full text-sm">
                    <thead>
                        <tr className="border-b bg-orange-50/60">
                            ...
                            {headers.map((h, i) => (
                                <th
                                    key={i}
                                    className={`min-w-[120px] p-3 text-left text-xs font-semibold ${i === questionCol
                    ...
                    <tbody>
                        {rows.map((row, ri) => (
                            <tr
                                key={ri}
                                className={`border-b last:border-0 transition-colors ${selectedRows.has(ri)
                                        ? "bg-orange-50"
                                        : "hover:bg-gray-50/60"
                                    }`}
                            >
                                ...
                                {headers.map((_, ci) => (
                                    <td
                                        key={ci}
                                        className={`p-3 align-top text-xs ${ci === questionCol
