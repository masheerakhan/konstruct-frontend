// frontendservice/kounstruct-frontend/src/containers/setup/Safety_setup/SafetyCategory.jsx
import React, { useState, useEffect } from "react";
import { toast } from "react-hot-toast";
import { listSafetyCategories, createSafetyCategory } from "../../../api";
...
function SafetyCategory({
    ...
    const handleAdd = async () => {
        ...
        setAddLoading(true);
        try {
            const res = await createSafetyCategory({
                org_id: Number(orgId),
            ...
            if (created?.id) {
                ...
                const listRes = await listSafetyCategories({
                    org_id: orgId,
                    project_id: projectId,
                    active: true,
                });
